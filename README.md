...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/epc-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4581&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/epc-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `epc` can be installed with `conda`:
...
It is possible to list all of the versions of `epc` available on your platform with `conda`:
...
```
mamba search epc --channel conda-forge
```
...
mamba repoquery search epc --channel conda-forge

# List packages depending on `epc`:
mamba repoquery whoneeds epc --channel conda-forge

# List dependencies of `epc`:
mamba repoquery depends epc --channel conda-forge
```
